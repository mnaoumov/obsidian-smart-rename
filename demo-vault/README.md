...
- **Otherwise**, download `smart-rename-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-smart-rename/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `smart-rename-demo-vault-<version>` folder it unzips into.
