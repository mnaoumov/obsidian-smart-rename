...
**How to try it:** open [Rename me](<./Rename me.md>), run **Smart Rename: Invoke** from the Command Palette (or right-click the note and choose the smart rename option), and type a new title. Then look at [References/Note A](<./References/Note A.md>) and [References/Note B](<./References/Note B.md>) - the links still show the old title.
